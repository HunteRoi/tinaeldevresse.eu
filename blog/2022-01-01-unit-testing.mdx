...
<AnchoredP id='what-is-tdd'>
	Well anyways! You can't stop mentioning it so here it is: what is Test Driven
	Development (TDD)?
</AnchoredP>
...
<AnchoredP id='what-is-tcr'>
	🔸 Nice! By the way, I heard you recently learnt about "Test &amp;&amp; Commit
	|| Revert" (TCR). What is it?
</AnchoredP>
