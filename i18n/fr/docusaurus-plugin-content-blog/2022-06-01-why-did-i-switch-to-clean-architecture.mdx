...
J'ai donc creusé cette partie de mon travail que je négligeais à l'époque: le testing. Grâce à mon expérience chez PwC Luxembourg, j'ai rencontré des gens formidables qui m'ont appris énormément de nouvelles choses.
...
Et je suis allé à l'école! On m'a expliqué l'injection de dépendances, les principes SOLID, le clean code, comment préparer le développement d'une application et éviter la majorité des bugs...
Mais ce n'est pas pour autant que je n'ai jamais écrit de code horrible ou d'applications bugués ou patché une fonctionnalité et casser quelque chose d'autre en passant.
...
Je suggère donc que tu regardes à ces ressources pour avoir un context plus historique, des explications et informations précises sur le sujet:
...
-   Si tu veux voir un exemple de cette structure, n'hésite pas à regarder [Cloud Filesystem](https://github.com/hunteroi/cloud-filesystem), un de mes projets open-source!
