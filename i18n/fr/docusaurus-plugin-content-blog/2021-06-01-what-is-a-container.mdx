...
### Qu'est-ce que c'est?
[Docusaurus](https://docusaurus.io), c'est un générateur de sites web optimisés qui embarque plusieurs fonctionnalités intéressantes pour les créateurs de contenu en ligne:
...
- le projet est [open source](https://github.com/facebook/docusaurus)
...
- Il est open source, je peux donc y contribuer si j'en ressens l'envie.
...
<Figure data={{ src: "https://i.imgur.com/PnvK7v6.png", alt: "It Works On My Computer", type: "image" }}>
  De [Don't Hit Save](https://donthitsave.com/comic/2016/07/15/it-works-on-my-computer)
</Figure>
...
1) le logiciel, appelé Docker daemon, est un processus qui gère les conteneurs Docker et les objets en résultant ;
2) les objets, divisés eux-mêmes en 3 catégories, sont des entités qui permettent de construire une application dans Docker:
  ...
  - un **service** est un système qui permet d'orchestrer les opérations de plusieurs conteneurs gérés par plusieurs daemons. Ca porte aussi le nom de _Swarm_ (un ensemble de Docker daemons qui communiquent entre eux grâce à Docker).
3) les registres sont des entrepôts pour les images Docker.
...
<Figure data={{ type: "html", width: "560", height: "315", src: "https://www.youtube.com/embed/iqqDU2crIEQ", title: "YouTube video player of Docker tutorial", frameborder: "0", allow: "accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture", allowfullscreen: true }}>
