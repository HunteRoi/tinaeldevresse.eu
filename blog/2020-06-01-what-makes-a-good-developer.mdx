...
<Figure data={{src:'/img/what-makes-a-good-developer.jpg', alt: 'post banner image', type:'image'}}>
...
title: 'Looking Logan Lerman GIF By Hunters', style: {position:'absolute'}, allowFullScreen: true, frameBorder:"0", className: 'giphy-embed' }}>
  From <a target="_blank" href="https://giphy.com/gifs/HuntersOnPrime-entertainment-monkeypaw-monkeypawproductions-Ph6mVLp87pCVCkHOBQ" rel="noreferrer noopener nofollow">GIPHY</a>
</Figure>
...
<Figure data={{src: 'https://i.imgur.com/qbDVKh7.png', alt: 'theres no need to reinvent the wheel - meme', type:'image'}}>
  From <a target="_blank" href="https://www.reddit.com/r/ProgrammerHumor/comments/cgtk7s/theres_no_need_to_reinvent_the_wheel_oc/" rel="noreferrer noopener nofollow">r/ProgrammerHummor</a>
</Figure>
...
However even if your code is understood by the computer, is it by humans? At some point, there will be another developer who will have to read your code and edit it. And it should be cristal clear for them.
...
<Figure data={{src: 'https://i.imgur.com/mva14iu.jpg', alt: 'When you get to see people using your program - meme', type: 'image', style: {margin: '0 auto'} }}>
  From <a target="_blank" href="https://imgur.com/gallery/Zc1BDHB" rel="noreferrer noopener nofollow">Imgur</a>
</Figure>
...
## 7. See things from the user's standpoint 
...
For example, a lot of the ones I attend are organized by the [Microsoft Innovation Center Belgique](http://www.mic-belgique.be/ "MIC's website").

- I get involved in communities. 
For example, I'm an active member of [SpaceY](https://www.wearespacey.com "SpaceY's website")!
