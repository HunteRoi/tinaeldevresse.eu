...
<a href="/blog/what-makes-a-good-developer">
  <Figure data={{src:'/img/what-makes-a-good-developer.jpg', alt: "Qu'est-ce qui fait un bon développeur", type:'image'}}>
...
title: 'Looking Logan Lerman GIF By Hunters', style: {position:'absolute'}, allowFullScreen: true, frameBorder:"0", className: 'giphy-embed' }}>
  De <a target="_blank" href="https://giphy.com/gifs/HuntersOnPrime-entertainment-monkeypaw-monkeypawproductions-Ph6mVLp87pCVCkHOBQ" rel="noreferrer noopener nofollow">GIPHY</a>
</Figure>
...
<Figure data={{src: 'https://i.imgur.com/qbDVKh7.png', alt: 'y a pas besoin de réinventer la roue - meme', type:'image'}}>
  De <a target="_blank" href="https://www.reddit.com/r/ProgrammerHumor/comments/cgtk7s/theres_no_need_to_reinvent_the_wheel_oc/" rel="noreferrer noopener nofollow">r/ProgrammerHummor</a>
</Figure>
...
Ca peut sembler bête mais tu es payé pour **faire marcher des choses**. Donc ne lance pas des instructions dans un fichier en espérant que ça marche correctement. Le plus tôt tu fais de bonnes choses, le meilleur ton application sera.
...
<Figure data={{src: 'https://i.imgur.com/mva14iu.jpg', alt: 'quand tu as l\'occasion de voir comment les utilisateurs utilisent ton app - meme', type: 'image', style: {margin: '0 auto'} }}>
  D'<a target="_blank" href="https://imgur.com/gallery/Zc1BDHB" rel="noreferrer noopener nofollow">Imgur</a>
</Figure>
...
<Figure data={{src:'https://i.redd.it/fb6xxzrrtfr21.png', alt:'UI vs UX - meme', type: 'image' }}>
...
Par exemple, de nombreux événements auxquels j'assite sont organisés par le [MIC Belgique](http://www.mic-belgique.be/ "web site du MIC").

- Je m'implique dans des communautés.
Par exemple, je suis un membre actif de [SpaceY](https://www.wearespacey.com "web site de SpaceY")!
