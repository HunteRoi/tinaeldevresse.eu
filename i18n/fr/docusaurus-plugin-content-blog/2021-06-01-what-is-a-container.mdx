...
- léger et rapide,
- portable et standard, donc multi-plateforme (dans une certaine mesure).
...
Un problème important qui se pose lors de l'utilisation de Docker est évidemment la sécurité!
...
<Figure data={{ type: "html", width: "560", height: "315", src: "https://www.youtube.com/embed/iqqDU2crIEQ", title: "YouTube video player of Docker tutorial", allow: "accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture", allowFullScreen: true }}>
  Trouvé sur <a href="https://docs.docker.com/get-started">docs.docker.com</a>
</Figure>
