...
- **it saves money and time**: you can build things and be sure changes (e.g. optimization) won't break working stuff thus forcing you to check why things is not doing things as expected;
