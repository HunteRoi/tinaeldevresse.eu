...
Joins-toi à moi pour le remercier pour son incroyable implication dans l'écriture de cet article! Nous espérons tous les deux que tu vas l'adorer, autant que nous avons adorer l'écrire.
...
<AnchoredP id='what-is-it'>
	...
	ce qu'est un test unitaire s'il te plaît?
</AnchoredP>
...
<AnchoredP id='what-is-tcr'>
	...
	<span style={{ fontStyle: "italic" }}>Test &amp;&amp; Commit || Revert</span>{" "}
