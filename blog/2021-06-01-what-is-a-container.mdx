...
title: What Is A Container And Why Use It?
...
1) the last update of the Docusaurus library which now allows me to provide you my blog in 2 languages!
...
### What Is It?
[Docusaurus](https://docusaurus.io) is a optimized website generator packaging several interesting features for online content creators:
- documentation and blog posts are written in [Markdown](https://www.markdownguide.org/getting-started/)
- internationalization is possible
- versioning is possible
- content search is highly adapted, thanks to the integration of [Algolia](https://www.algolia.com/)
- it's [open-source](https://github.com/facebook/docusaurus)

### Why Docusaurus?
Indeed, you might ask the question. Why choosing Docusaurus when there are plenty of other site generators such as Wix, Shopify, Weebly, ... or more axed on developer mindset such as Next.js, Hugo, Gatsby, and so on...
...
However, I personnaly chose Docusaurus for my personal projects for 3 reasons:
- it is open-source, so I contribute if I want to.
- it is developed in React, and I love this library.
- it is easily usable: in around 3 minutes, you can have functional and customized website.
...
<Figure data={{ src: "https://i.imgur.com/PnvK7v6.png", alt: "It Works On My Computer", type: "image" }}>
  From [Don't Hit Save](https://donthitsave.com/comic/2016/07/15/it-works-on-my-computer)
</Figure>
...
The big difference between each is that a container makes use of the host machine operating system (OS) whereas a VM loads its own OS. And obviously, it is heavier and slower.

<Figure data={{ src: "/img/container_against_VM.jpg", alt: "Container VS Virtual Machine", type: "image" }}></Figure>

These are the arguments that Docker (world leader of the IT container market) uses:
- lightweight and fast
- secure
- portable and standard, thus cross-platform
...
1) the software, called Docker daemon, is a process managing Docker containers and resulting objects ;
2) the objects, themselves seperated in 3 categories, are entities which allow to build an application with Docker:
  ...
  - a **service** is a system which orchestrates the operations of several containers maanged by multiple daemons. It is also called a _swarm_ (a set of Docker daemons which communicate via Docker).
3) the registries are repositories for Docker images.
...
<Figure data={{ type: "html", width: "560", height: "315", src: "https://www.youtube.com/embed/iqqDU2crIEQ", title: "YouTube video player of Docker tutorial", frameborder: "0", allow: "accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture", allowfullscreen: true }}>
  Found on [docs.docker.com](https://docs.docker.com/get-started)
</Figure>
...
- Broad compatibiltiy (the OS does not matter, so each developer can work on their favorite one)
