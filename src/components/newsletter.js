  ...
  return (
    <div className={styles.formContainer}>
      ...
      <div className={styles.inputContainer}>
        ...
        />
        <a className={styles.submit} rel="noopener" onClick={submit}>
      ...
      {status === 'sending' && <div className={styles.statusSending}><Translate id='newsletter.sending' description='The text stating the email is being registered in the newsletter list'>Sending...</Translate></div>}
      {status === 'error' && <div className={styles.statusError} dangerouslySetInnerHTML={{ __html: message }} />}
      {status === 'success' && <div className={styles.statusSuccess} dangerouslySetInnerHTML={{ __html: message }} />}
    </div>
  );
};
