...
<Figure data={{src:'/img/what-makes-a-good-developer.jpg', type:'image'}}>
  Photo by <a target='_blank' href='https://unsplash.com/@anniespratt'>Annie Spratt</a> on <a href='https://unsplash.com/'>Unsplash</a>
</Figure>
...
title: 'Looking Logan Lerman GIF By Hunters', style: {position:'absolute'}, allowFullScreen: true, frameBorder:"0", className: 'giphy-embed' }}>
  From <a href="https://giphy.com/gifs/HuntersOnPrime-entertainment-monkeypaw-monkeypawproductions-Ph6mVLp87pCVCkHOBQ">GIPHY</a>
</Figure>
...
## 4. Write clean & working code and test it
### Write clean & working code
This could sound silly but you are paid to make things work. But don't just throw instructions in a file and hope that they work properly. The sooner you make things good, the better the application will be. Navdeep Singh wrote a story about <a href="https://medium.com/better-programming/good-code-vs-bad-code-35624b4e91bc">why writing good code matters, and how to do it</a>. Check it out, it's neat!
...
<Figure data={{src: 'https://i.imgur.com/mva14iu.jpg', type: 'image', style: {margin: '0 auto'} }}>
  From <a href='https://imgur.com/gallery/Zc1BDHB'>Imgur</a>
</Figure>

Testing in software development is in my humble opinion the most important step in the process of product development. And there are many reasons to support this obviousness. Here are a few examples:
...
<Figure data={{src:'https://i.redd.it/fb6xxzrrtfr21.png', type: 'image' }}>
  From <a href='https://www.reddit.com/r/UI_Design/comments/bblxum/ui_vs_ux/'>/r/UI_Design</a>
</Figure>
...
For example, a lot of the ones I attend are organized by the <a target='_blank' href='http://www.mic-belgique.be/'>Microsoft Innovation Center Belgique</a>.

- I get involved in communities. 
For example, I'm an active member of <a target='_blank' href="https://github.com/wearespacey">We Are SpaceY</a>!
